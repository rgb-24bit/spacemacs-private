...
(defun my-c-c++/init-clang-format ()
...
(defun my-c-c++/post-init-helm-gtags ()
  (dolist (mode c-c++-modes)
...
(defun my-c-c++/post-init-srefactor ()
  (dolist (mode c-c++-modes)
